...
const SocialFeed = () => {
    ...
    return (
        <section id="social" className="py-24 bg-sand-50 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-center justify-center">
                    <Motion.div
                        ...
                        viewport={{ once: true }}
                        className="w-full max-w-[540px] bg-white p-2 rounded-2xl shadow-xl border border-sand-100"
                    >
                        <blockquote
                            className="instagram-media"
                            data-instgrm-captioned
                            data-instgrm-permalink="https://www.instagram.com/reel/DVGPwHkDe_A/?utm_source=ig_embed&amp;utm_campaign=loading"
                        ...
                        >
                            <div style={{ padding: '16px' }}>
                                <a
                                    href="https://www.instagram.com/reel/DVGPwHkDe_A/?utm_source=ig_embed&amp;utm_campaign=loading"
                                ...
                                >
                                    ...
                                    <div style={{ display: 'block', height: '50px', margin: '0 auto 12px', width: '50px' }}>
                                        <svg width="50px" height="50px" viewBox="0 0 60 60" version="1.1" xmlns="https://www.w3.org/2000/svg" xmlnsXlink="https://www.w3.org/1999/xlink">
                                            {/* SVG content simplified for brevity in React, keeping original path */}
                                ...
                                <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                    <a href="https://www.instagram.com/reel/DVGPwHkDe_A/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noreferrer">A post shared by Rabbits Hub | Cute &amp; Healthy Rabbits (@rabbits_hub1000)</a>
                                </p>
                            </div>
                        </blockquote>
                    </Motion.div>
                    ...
                    >
                        <h3 className="text-3xl font-serif text-primary-dark">Connect with Us</h3>
                        <p className="text-gray-600 leading-relaxed">
                            Stay up to date with our latest breeding pairs, cute kits, and farm updates on Instagram. Join our community of rabbit enthusiasts!
                        </p>
                        <a
                            href="https://www.instagram.com/rabbits_hub1000/"
                            target="_blank"
                            rel="noreferrer"
                            className="btn-primary inline-flex items-center"
                        >
                            Follow @rabbits_hub1000
                        </a>
                    </Motion.div>
                </div>
            </div>
